...
# Generated on: Tue Mar 24 08:40:32 IST 2026 (Tue Mar 24 03:10:32 UTC 2026)
...
set logfile fv/parallel/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/parallel -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  parallel4b4.v
elaborate_design -golden -root {parallel} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/parallel/fv_map.v.gz
elaborate_design -revised -root {parallel}
...
#add_name_alias fv/parallel/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.parallel.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.parallel.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.parallel.rtl.fv_map.rpt
