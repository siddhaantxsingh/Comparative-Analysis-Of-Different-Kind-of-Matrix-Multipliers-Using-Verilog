...
# Generated on: Tue Mar 24 09:32:21 IST 2026 (Tue Mar 24 04:02:21 UTC 2026)
...
set logfile fv/serial/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/serial -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  serial3b3.v
elaborate_design -golden -root {serial} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/serial/fv_map.v.gz
elaborate_design -revised -root {serial}
...
#add_name_alias fv/serial/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.serial.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.serial.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.serial.rtl.fv_map.rpt
